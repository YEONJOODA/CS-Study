...
namespace Ch06
{
    internal class _6_InternalClass
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("올림값 : "+Math.Sqrt(1.2));
            Console.WriteLine("올림값 : "+Math.Sqrt(1.8));
            Console.WriteLine("내림값 : "+Math.Sqrt(1.2));
            Console.WriteLine("내림값 : "+Math.Sqrt(1.8));
            Console.WriteLine("반올림 : "+Math.Sqrt(1.2));
            Console.WriteLine("반올림 : "+Math.Sqrt(1.8));
            Console.WriteLine();
            ...
            Console.WriteLine("num3 : "+ num3);     // 0 ~ 10 사이의 임의의 정수
